/* Boxing Center Saint-Cyprien — libs d’animation, auto-hébergées.
   gsap 3.12.5 (MIT/standard) + ScrollTrigger 3.12.5 + @studio-freight/lenis 1.0.42.
   Regroupées en un seul fichier same-origin : 3 requêtes tierces -> 1 requête locale,
   plus de résolution DNS/TLS vers un CDN externe avant la première animation. */
